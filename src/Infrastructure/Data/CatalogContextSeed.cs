    ...
    public class CatalogContextSeed
    {
        ...
        private static IEnumerable<CatalogItem> GetPreconfiguredItems()
        {
            return new List<CatalogItem>()
            {
                ...
                new CatalogItem() { CatalogTypeId=1,CatalogBrandId=2, Description = ".NET Black & White Mug", Name = ".NET Black & White Mug", Price= 1.50M, PictureUri = "http://catalogbaseurltobereplaced/images/products/2.png" },
                ...
                new CatalogItem() { CatalogTypeId=2,CatalogBrandId=2, Description = ".NET Foundation Sweatshirt", Name = ".NET Foundation Sweatshirt", Price = 12.05M, PictureUri = "http://catalogbaseurltobereplaced/images/products/4.png" },
